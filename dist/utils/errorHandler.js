...
const errorHandler = (err, req, res, next) => {
    ...
    else if (rawCode === 'INSUFFICIENT_BALANCE' ||
    ...
    else if (rawCode === 'INSUFFICIENT_AREA' ||
    ...
    else if (rawCode === 'INVALID_SOURCE_AREA' ||
    ...
    else if (rawCode === 'VALUATION_CONFIG_MISSING' ||
    ...
    else if (rawCode === 'BLOCKCHAIN_ASSET_MISSING' ||
    ...
    const details = err.validationDetails;
