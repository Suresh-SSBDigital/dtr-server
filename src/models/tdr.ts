...
const schema = new Schema<TDRDocument>(
  {
    ...
    land: { type: Schema.Types.Mixed, required: true },
    total_tdr_value: { type: Number },
    utilized_tdr_value: { type: Number, default: 0 },
    remaining_tdr_value: { type: Number },
    plots: [{ type: Schema.Types.Mixed }],
    transfers: [{ type: Schema.Types.Mixed }],
    utilizations: [{ type: Schema.Types.Mixed }],
    new_drc_of_owner: [{ type: Schema.Types.Mixed }],
    objection_suggestions: [{ type: Schema.Types.Mixed }],
    ledger: [{ type: Schema.Types.Mixed }],
...
export default mongoose.model<TDRDocument>('TDR', schema);
